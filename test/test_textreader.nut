...
UTF16=[0xa3, 0x03, 0x72, 0x1f, 0x20, 0x00, 0xb3, 0x03, 0xbd, 0x03, 0xc9, 0x03, 0xc1, 0x03, 0xaf, 0x03, 0xb6, 0x03, 0xc9, 0x03, 0x20],
...
UTF16=[0x66, 0x00, 0x72, 0x00, 0x61, 0x00, 0x6e, 0x00, 0xe7, 0x00, 0x61, 0x00, 0x69, 0x00, 0x73, 0x00, 0x20, 0x00, 0x6c, 0x00, 0x61, 0x00, 0x6e, 0x00, 0x67, 0x00, 0x75, 0x00, 0x65, 0x00, 0x20, 0x00, 0xe9, 0x00, 0x74, 0x00, 0x72, 0x00, 0x61, 0x00, 0x6e, 0x00, 0x67, 0x00, 0xe8, 0x00, 0x72, 0x00, 0x65],
...
UTF16=[0x6d, 0x00, 0x61, 0x00, 0xf1, 0x00, 0x61, 0x00, 0x6e, 0x00, 0x61, 0x00, 0x20, 0x00, 0x6f, 0x00, 0x6c, 0x00, 0xe9],
...

{
	...
	{
		print( "Test: " + t.name + "\n");
		local rdr = textreader( mk_blob( t.UTF8));
		while( !rdr.eos())
		{
...
{
	local f = file( "test/file_tl_lf_utf8.txt", "r");
	local rdr = textreader( f);
