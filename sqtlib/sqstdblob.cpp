...
{
    sq_pushstring(v,std_blob_decl.name,-1);
    return 1;
}
...
const SQTClassDecl std_blob_decl = {
...
SQUserPointer sqstd_createblob(HSQUIRRELVM v, SQInteger size)
{
    ...
    sq_pushstring(v,std_blob_decl.reg_name,-1);
...
{
	if(SQ_SUCCEEDED(sqt_declareclass(v,&std_blob_decl)))
	{
		sq_poptop(v);
		return SQ_OK;
	}
