...
SQUIRREL_API SQRESULT sqt_serbin_load(HSQUIRRELVM v, const SQChar *opts, SQSTREAM stream);
SQUIRREL_API SQRESULT sqt_serbin_save_cb( HSQUIRRELVM v, const SQChar *opts, SQWRITEFUNC writefct, SQUserPointer user);
SQUIRREL_API SQRESULT sqt_serbin_save( HSQUIRRELVM v, const SQChar *opts, SQSTREAM stream);
